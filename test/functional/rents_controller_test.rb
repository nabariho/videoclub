...
class RentsControllerTest < ActionController::TestCase
  ...
  test "should create rent" do
    assert_difference('Rent.count') do
      post :create, rent: { end_date: @rent.end_date, film_id: @rent.film_id, start_date: @rent.start_date, user_id: @rent.user_id }
    end
  ...
  test "should update rent" do
    put :update, id: @rent, rent: { end_date: @rent.end_date, film_id: @rent.film_id, start_date: @rent.start_date, user_id: @rent.user_id }
    assert_redirected_to rent_path(assigns(:rent))
  end
